...
//     }
   ...
   stage('Docker build and push') {
	 ...
	 echo $secret_key
         ...
         docker login -u AWS -p $DOCKER_LOGIN_PASSWORD 319289154825.dkr.ecr.ap-south-1.amazonaws.com
	 docker build -t 319289154825.dkr.ecr.ap-south-1.amazonaws.com/manoj:SAMPLE-PROJECT-${BUILD_NUMBER} .
	 docker push 319289154825.dkr.ecr.ap-south-1.amazonaws.com/manoj:SAMPLE-PROJECT-${BUILD_NUMBER}
